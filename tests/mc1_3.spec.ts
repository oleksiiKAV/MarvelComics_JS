...
test.describe('The application shall have two pages and navigation between them', () => {
  ...
  test('MC1 The application shall be implemented as a two-page web application. MC2 The initial page of the application shall contain an "All characters" button, which, when clicked, navigates to the next page.',
    async ({ page }) => {
  ...
  test('MC3 The second page of the application shall include a "BACK HOME" button, allowing users to return to the initial page.', async ({ page }) => {
